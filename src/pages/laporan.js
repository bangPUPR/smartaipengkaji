        ...
        <div class="laporan-content" id="print-area">
          ...
          <div id="lap-bab4" class="laporan-section pdf-page-break" style="page-break-before:always">
            ...
            ${analisis.narasi_teknis ? `
              <h3>4.3. Analisis Mendalam per Aspek</h3>
              <div class="bab4-narasi-content">
                ${analisis.narasi_teknis.includes('## ASPEK PEMERIKSAAN:') 
                  ? marked.parse(analisis.narasi_teknis) 
                  : renderToHTML(parseNarasiAI(analisis.narasi_teknis))}
              </div>
            ` : `
              <div style="padding:24px;text-align:center;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;margin:16px 0">
                <i class="fas fa-info-circle" style="color:#64748b;font-size:1.5rem;margin-bottom:8px"></i>
                <p style="color:#64748b;font-size:0.9rem">Narasi teknis BAB IV belum tersedia. Lakukan Sintesis pada halaman Analisis.</p>
              </div>
            `}
          </div>
